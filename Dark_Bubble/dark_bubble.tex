...
\numberwithin{equation}{section}%Each number section sets the starting number of the equation X.YY
\geometry{
...
\input{contents/simple_example.tex}
\input{contents/db_from_st.tex}
\input{contents/quantum_bubbles.tex}
\input{contents/decoration.tex}
\input{contents/holography.tex}
\input{contents/FAQ.tex}
